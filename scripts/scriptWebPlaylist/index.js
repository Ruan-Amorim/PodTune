...
if ('mediaSession' in navigator) {
    ...
    function updateMediaSession() {
      ...
      navigator.mediaSession.metadata = new MediaMetadata({
        title: newLista[numberMuisc].nome_musica, // Título da música
        artist: newLista[numberMuisc].nome_artista, // Nome do artista
        artwork: [
          { src: newLista[numberMuisc].capa, sizes: '512x512', type: 'image/jpg' } // Imagem da capa do álbum
        ]
      });
